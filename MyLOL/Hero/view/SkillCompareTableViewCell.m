...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _image1.frame = (CGRectMake(KScreenWidth * 2/7, 0, KScreenWidth/7, KScreenWidth/7));
        [self.contentView addSubview:_image1];
        
        _image2 = [UIButton buttonWithType:(UIButtonTypeCustom)];
        _image2.frame = (CGRectMake(KScreenWidth * 4/7, 0, KScreenWidth/7, KScreenWidth/7));
        [self.contentView addSubview:_image2];
        
        _flowImage1 = [[UIImageView alloc]initWithFrame:_image1.frame];
        _flowImage1.backgroundColor = [UIColor blackColor];
        _flowImage1.alpha = 0;
        [self.contentView addSubview:_flowImage1];
        
        _flowImage2 = [[UIImageView alloc]initWithFrame:_image2.frame];
        _flowImage2.backgroundColor = [UIColor blackColor];
        _flowImage2.alpha = 0.5;
        [self.contentView addSubview:_flowImage2];
...
- (void)layoutSubviews{
    ...
    _skillNameLabel.frame = (CGRectMake(0, _image1.frame.origin.y + _image1.bounds.size.height, 200, 30));
...
- (void)setSkillModel:(SkillModel *)skillModel{
    ...
    _effectLabelI.text = _skillModel.effect;
    _rangeLabelI.text = _skillModel.range;
    _coolDownLabelI.text = _skillModel.cooldown;
    _consumeDesLabelI.text = _skillModel.cost;
    _skillNameLabel.text = _skillModel.name;
